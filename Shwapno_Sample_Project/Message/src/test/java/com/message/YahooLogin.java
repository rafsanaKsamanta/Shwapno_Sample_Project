...
public class YahooLogin extends DriverSetup {
	...
	public static void login() throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@id='login-username']")).sendKeys("fortest178@yahoo.com");
		Thread.sleep(1000);
		driver.findElement(By.xpath("//input[@id='login-signin']")).click();
		Thread.sleep(1000);

		driver.findElement(By.xpath("//input[@id='login-passwd']")).sendKeys("abcdef14");
		Thread.sleep(1000);
	...
	public static void sendMessage() throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@id='message-to-field']")).sendKeys("niazmorshed1494@gmail.com");
		Thread.sleep(1000);

		driver.findElement(By.xpath("//input[contains(@data-test-id,'compose-subject')]")).sendKeys("Hello");
		Thread.sleep(1000);

		driver.findElement(By.xpath("//div[@data-test-id='rte']")).sendKeys("Hellow World");
		Thread.sleep(1000);
